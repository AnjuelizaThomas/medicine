...
public partial class Customer_Reg : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con2.Open();
        string str = "insert into register(firstname,lastname,state,district,city,email,phone,username,password) values('" + TextBox1.Text.Trim() + "','" + TextBox2.Text.Trim() + "','" + DropDownList1.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "','" + DropDownList3.SelectedItem.Text + "','" + TextBox3.Text.Trim() + "','" + TextBox4.Text.Trim() + "','" + TextBox5.Text.Trim() + "','" + TextBox7.Text.Trim() + "')";
        String str2 = "insert into login(username,password,usertype) values('" + TextBox5.Text.Trim() + "','" + TextBox7.Text.Trim() + "','customer')";
