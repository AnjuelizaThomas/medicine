<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_dealer.aspx.cs" Inherits="Add_dealer" %>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <label><b><h3>Dealer Creation</h3></b></label>
                        <div class="form-group">
                          
                             <p class="help-block">Dealer Name</p>
                        ...
                        <div class="form-group">
                             ...
                             <p class="help-block">Company<asp:Label ID="lblcatid" runat="server" Text="Label" Visible="False"></asp:Label>
                             </p>
                            <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" DataSourceID="SqlDataSource1" DataTextField="company_name" DataValueField="company_name" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
                           
                            
                             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT [company_name] FROM [add_company]"></asp:SqlDataSource>
                           
                            
                             <asp:Label ID="lblcmpid" runat="server" Text="Label" Visible="False"></asp:Label>
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"  required="required" TextMode="Phone"></asp:TextBox>
                           
                        </div>
                        <div class="form-group">
                          
                             <p class="help-block">Email</p>
                             <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control"  required="required" AutoPostBack="True"  TextMode="Email"></asp:TextBox>
                        ...
                        <div class="form-group">
                             ...
                             <p class="help-block">Product<asp:Label ID="Label1" runat="server" Text="Label" Visible="False"></asp:Label>
                             </p>
                            <asp:DropDownList ID="DropDownList2" CssClass="form-control" runat="server" DataSourceID="SqlDataSource2" DataTextField="item_name" DataValueField="item_name" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"></asp:DropDownList>
                            
                             <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT [item_name] FROM [add_product]"></asp:SqlDataSource>
