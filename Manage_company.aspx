<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage_company.aspx.cs" Inherits="manage" %>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <label><b>Manage Company </b></label>
                        </div>
                </div>
                  <div class="form-group">
                          
                             <p class="help-block"> Select Company name</p>
                      <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server" DataSourceID="SqlDataSource2" DataTextField="company_name" DataValueField="company_name" AutoPostBack="True"></asp:DropDownList>
                  ...
                  <div class="form-group">
                      ...
                      <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="478px" BorderColor="#0099FF" BorderStyle="Groove" CaptionAlign="Top">
                          <Columns>
                              ...
                              <asp:ButtonField ButtonType="Button" CommandName="Edit" HeaderText="Action" Text="Edit" />
                              <asp:ButtonField ButtonType="Button" CommandName="Delete" HeaderText="Actio" ShowHeader="True" Text="Delete" />
                          </Columns>
                      </asp:GridView>  
                           
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT [company_code], [company_name], [email], [city], [phone] FROM [add_company] WHERE ([company_name] = @company_name)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList1" Name="company_name" PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
                      </asp:SqlDataSource>
